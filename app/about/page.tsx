    ...
    <>
      ...
      <main className="pt-[72px] bg-[#e5e7eb]">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          {/* Values Section */}
          <section className="py-16 md:py-24 bg-[#e5e7eb] rounded-3xl">
                ...
                >
                  <div className="flex justify-center mb-6">
                    <div className="p-4 rounded-xl bg-gradient-to-br from-[#4fd1c5]/10 to-[#3f6d63]/10 group-hover:from-[#4fd1c5]/20 group-hover:to-[#3f6d63]/20 transition-colors">
                      <value.icon className="h-8 w-8 text-[#3f6d63]" />
                    </div>
                  </div>
          ...
          {/* Founder Section */}
          <section className="py-16 md:py-24 bg-[#f0f2f5] rounded-3xl">
            <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center bg-clip-text text-transparent bg-gradient-to-r from-[#4fd1c5] to-[#3f6d63]">
              Meet the Founder
            </h2>
            <div className="flex flex-col md:flex-row items-center gap-12 max-w-4xl mx-auto">
              ...
              <div
                className="flex-1 p-8 rounded-[28px]"
                style={{
                  backgroundColor: "#f0f2f5",
                  border: "2px solid #9ca3af",
                  boxShadow: "0 6px 16px rgba(0, 0, 0, 0.15)",
          ...
          {/* Commitment Section */}
          <section className="py-16 md:py-24">
            <div className="bg-[#f0f2f5] rounded-3xl p-12">
              <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center bg-clip-text text-transparent bg-gradient-to-r from-[#4fd1c5] to-[#3f6d63]">
                Our Commitment
              </h2>
